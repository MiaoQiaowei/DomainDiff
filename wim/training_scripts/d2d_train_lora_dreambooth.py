...
class MultiDataset():
    "A style domain with multiple class self training."
    ...
    def __init__(
        ...
        # d2d dataset
        self.dataset = ImageFolder(instance_data_root, self.image_transforms)
    ...
    def __getitem__(self, index):
        ...
        text_label = self.classes[label].replace('_',' ')
        instance_prompt = f'{self.instance_prompt} {text_label}.'
